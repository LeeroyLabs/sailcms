...
class EntryType extends Model
{
    ...
    {
        // TODO: FIX THIS, Value can be string and crashes the whole thing
        if ($field === "url_prefix") {
            return new LocaleField(['fr' => '', 'en' => '']);
        }
        return parent::processOnFetch($field, $value); // TODO: Change the autogenerated stub
    }
